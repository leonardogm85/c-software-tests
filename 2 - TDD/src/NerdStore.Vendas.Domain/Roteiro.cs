namespace NerdStore.Vendas.Domain
{
    public class Roteiro
    {
        ...
        Independete da ação, um item precisa ser sempre valido:
            Possuir: Id e nome do produto, quantidade entre 1 e 15 unidades, valor mais que 0
        ...
        2 - Atualização do Item
            ...
            2.4 - O item deve permanecer entre 1 e 15 unidades do produto
        ...
        4 - Aplicar voucher de desconto
            4.1 - O voucher só pode ser aplicado se estiver válido, para isto:
                ...
                4.1.5 - Uma das forma de desconto devem estar preenchidas com valor acima de 0
            ...
            4.3 - Quando o valor do desconto ultrapassa o valor total do pedido o pedido recebe o valor: 0
            4.4 - Após a aplicação do voucher o desconto deve ser re-calculado após toda modificação da lista de itens do pedido

         */

        /* PEDIDOS COMMANDS - HANDLER */

        /*

        O command hendler de pedido irá manipular um command para cada intenção em relação ao pedido.
        ...
        Na alteração do estado do pedido:

            De ser feita via repositório
